 ...
 require_once 'Conexion.php';
    class Ventas{
        ...
        public function registrarVenta($args, $tabla){
            ...
            $stmt = Conexion::conectarDB()->prepare("INSERT INTO $tabla (codigo, id_vendedor, productos,  total,
             total_costo , deuda ,metodo_pago,  fecha) VALUES ( :codigo, 
               :id_vendedor, :productos, :total, :total_costo, :deuda ,:metodo_pago,   :fecha)");
        ...
        public function actualizarVenta($args, $tabla){
            ...
            total=:total, total_costo=:total_costo, deuda=:deuda ,metodo_pago=:metodo_pago WHERE id= :id");
            $stmt->bindParam(":codigo", $args['codigo'], PDO::PARAM_STR);
